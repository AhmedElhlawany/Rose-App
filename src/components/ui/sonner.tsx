    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          toast:
            ' relative group toast h-12 group-[.toaster]:bg-zinc-100 group-[.toaster]:text-foreground group-[.toaster]:border-zinc-400 dark:group-[.toaster]:!bg-zinc-300 dark:group-[.toaster]:!text-zinc-800 dark:group-[.toaster]:!border-0',
