...
const badgeVariants = cva(
  "inline-flex items-center justify-center text-center rounded-2xl h-8 w-24 border px-2 py-0.5 text-lg font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
         primary:
